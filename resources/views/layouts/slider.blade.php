      ...
      <div class="tp-banner">
        <ul>
            ...
            <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
              <!-- MAIN IMAGE --> 
              <img src="{{$slider->image}}"  alt="slider"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
              <!-- LAYERS --> 
              ...
              <div class="tp-caption sfl font-extra-bold tp-resizeme" 
                  ...
                  data-endspeed="300" 
                  style="z-index: 6; font-size:80px; color:#2d3a4b; text-transform:uppercase; white-space: nowrap;">{{ $slider->title }}</div>
              <!-- LAYER NR. 2 -->
              <div class="tp-caption sfr font-extra-bold tp-resizeme" 
                  ...
                  data-endelementdelay="0.1" 
                  data-endspeed="300" 
                  style="z-index: 6; font-size:120px; color:black; text-transform:uppercase; white-space: nowrap;">{{$slider->detail}} </div>
